---
title: "FCE Sta. Isabel / Verto Inspect: Unauthenticated Read, Write, and Delete on Weaviate"
date: 2026-06-20
type: host
severity: CRITICAL
sector: commercial
summary: "Medical center and insurance inspection platform colocated on a single unprotected Weaviate 1.27.9 node. Unauthenticated RWD exposes clinical database schema (patient radiology, physical exams, doctor assignments) and full agent conversation logs from an unreleased insurance inspection product."
tags: [weaviate, vector-db, unauth, medical, critical, rwd, cat-13, healthcare, rwd-confirmed]
---
